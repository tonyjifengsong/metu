  ...
  /// </summary>
    ...
    public partial class METUCORE 
    {
       ...
       protected string appname { get; set; }
        ...
        /// <param name="servicename">应用下的服务分类名</param>
        ...
        /// <param name="id">企业用户名 （英文字符或手机号，唯一不重复）</param>
        /// <param name="appname">企业用户下的应用分类（ERP、CRM、WMS、MES、MTS、TMS、SSO、GPS等）</param>
        /// <param name="servicename">应用的服务分类名</param>
        /// <param name="methodname">服务中具体业务名</param>
        /// <returns></returns>
    ...
    /// <summary>
        ///  执行业通用务逻辑
        /// </summary>
        /// <param name="version">Varsion</param>
        /// <param name="id">企业用户名 （英文字符或手机号，唯一不重复） </param>
        /// <param name="appname">企业用户下的应用分类（ERP、CRM、WMS、MES、MTS、TMS、SSO、GPS等） </param>
        /// <param name="servicename">应用下的服务分类名 </param>
        /// <param name="methodname"> 服务中具体业务名</param>
        ...
        /// <param name="methodname">服务中具体业务名</param>
        /// <param name="tname">传入表名参数</param>
        /// <returns></returns>

        public dynamic Reports(   string tname,  string version = "0",   string id = "metu",   string appname = "metu",   string servicename = "service",   string methodname  = "call")
        {
            if (id == null)
            {
                return Result.ERROR(0, "应用未注册！");
        ...
        public object Login(Dictionary<string, object> model,string actname, string ctrl = null, string version = "0", string id = "metu", string appname = "metu", string servicename = "service", string methodname  = "call")
        {
            if (version == null)
            {
                version = "0";
        ...
        public object Loginwebservice(Dictionary<string, object> model, string ctrl = null, string version = "0", string id = "metu", string appname = "metu", string servicename = "service", string methodname  = "call")
        {
            if (version == null)
            {
                version = "0";
        ...
        public object Callwebservice(Dictionary<string, object> model, string ctrl = null, string version = "0", string id = "metu", string appname = "metu", string servicename = "service", string methodname  = "call")
        {
            if (version == null)
            {
                version = "0";
        ...
        public Result BatServiceNotTransRecords(Dictionary<string, object> model, string ctrl = null, string version = "0", string id = "metu", string appname = "metu", string servicename = "service", string methodname  = "call")
        {
            if (id == null)
            {
                return Result.ERROR(0, "应用未注册！");
        ...
        public Result ExecuteSQLServiceNotTransRecords(  Dictionary<string, object> model  , string ctrl = null, string version = "0", string id = "metu", string appname = "metu", string servicename = "service", string methodname  = "call")
        {
            if (id == null)
            {
                return Result.ERROR(0, "应用未注册！");
        ...
        public Result ReplaceTemplate( Dictionary<string, string> file,   string ctrl=null , string version = "0",   string id = "metu",   string appname = "metu",   string servicename = "service",   string methodname  = "call")
        {
