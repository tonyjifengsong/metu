...
/// 核心 操作数据库类
/// </summary>
public class CoreBLL : IDBHelper, ICBLL
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public CoreBLL(string config = null)
    {
        FileHelper.Writelog(config);
        FileHelper.Writelog("CoreBLL构造函数执行！");

        if (config == null)
        {
            FileHelper.Writelog("config is null!");
            config = CommonCache.MSSQLConnectionString;
            FileHelper.Writelog("默认：CommonCache.MSSQLConnectionString");
            FileHelper.Writelog(config);
        }
        else
        {
            try
            {
                FileHelper.Writelog("config!=null");
                FileHelper.Writelog(config);
                if (CommonCache.ConfigCaches[config] != null)
                {
                    FileHelper.Writelog("CommonCache.ConfigCaches[config]!=null");
                    config = CommonCache.ConfigCaches[config].ToString();
                    FileHelper.Writelog(config);
                }
                else
                {
        ...
        //  config = "Data Source=192.168.1.107;Initial Catalog=SMTDB;User ID=sa;Password=chy@1982;";
        optionsBuilder.UseSqlServer(config);
        dbh = new BaseDbContext(optionsBuilder.Options);
        db = new DBHelpers(optionsBuilder.Options);
    ...
    /// <returns></returns>
    public object PageInfo(string PageNameens)
    {
        string sqlstr = BaseSQL.SQL_GET_PAGECONTROL_LIST;
 ...
 /// <returns></returns>
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable DoCoreDataTable(Dictionary<string, string> dic)
    {
        string servicename = dic.ServiceName();
        string sqlstr = BaseSQL.SQL_SysPageService_List;//@"SELECT[ServiceEvents],[ReturnType]FROM[dbo].[SysPageService]where  [IsEnabled]=1 and [IsDeleted]=0 and [servicename]=N'{0}'";
    ...
    /// <param name="tname">数据库中表名</param>
    /// <returns></returns>
    public DataTable CommonReports(string tname)
    {
    ...
    public DataTable CommonconfigServices(Dictionary<string, string> dic)
    {

        string methodname = dic.ServiceName();
        methodname = methodname + "getconfig";
        dic.AddServiceName(methodname);
        return DoCoreDataTable(dic);
    }
    ...
    /// <param name="tname"></param>
    /// <returns></returns>
    public DataTable CommonPageInfo(string PageNameens)
    {
        string sqlstr = BaseSQL.SQL_GET_PAGECONTROL_LIST;
        sqlstr = sqlstr.Replace("{0}", PageNameens);
        sqlstr = sqlstr.Replace("=n'", "=N'");
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonServicessave(Dictionary<string, string> dic)
    {
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonServicesgets(Dictionary<string, string> dic)
    {
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonServices(Dictionary<string, string> dic)
    {
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonServicesadd(Dictionary<string, string> dic)
    {
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonServicesedit(Dictionary<string, string> dic)
    {
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonServicesupdate(Dictionary<string, string> dic)
    {
        string methodname = dic.ServiceName();
        methodname = methodname + "update";
        dic.AddServiceName(methodname);
    ...
    public DataTable CommonServicesdelete(Dictionary<string, string> dic)
    {
    ...
    /// <param name="dic">传入参数</param>
    /// <returns></returns>
    public DataTable CommonServicesremovebykey(Dictionary<string, string> dic)
    {
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonServicesget(Dictionary<string, string> dic)
    {
    ...
    public DataTable CommonServiceslist(Dictionary<string, string> dic)
    {
        string methodname = dic.ServiceName();
        methodname = methodname + "list";
        dic.AddServiceName(methodname);
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonService(Dictionary<string, string> dic)
    {
        string methodname = dic.ServiceName();
        methodname = methodname + "service";
        dic.AddServiceName(methodname);
    ...
    public DataTable CommonconfigServices(string methodname, Dictionary<string, string> dic)
    { 
        methodname = methodname + "getconfig";
        dic.AddServiceName(methodname);
        return DoCoreDataTable(dic);
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonServicessave(string methodname, Dictionary<string, string> dic)
    { 
        methodname = methodname + "save";
        dic.AddServiceName(methodname);
        return DoCoreDataTable(dic);
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonServicesgets(string methodname, Dictionary<string, string> dic)
    {  
        methodname = methodname + "get";
        dic.AddServiceName(methodname);
        return DoCoreDataTable(dic);
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonServices(string methodname, Dictionary<string, string> dic)
    { 
        methodname = methodname + "getlist";
        dic.AddServiceName(methodname);
        return DoCoreDataTable(dic);
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonServicesadd(string methodname, Dictionary<string, string> dic)
    {
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonServicesedit(string methodname, Dictionary<string, string> dic)
    {
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonServicesupdate(string methodname, Dictionary<string, string> dic)
    {
    ...
    public DataTable CommonServicesdelete(string methodname, Dictionary<string, string> dic)
    {
    ...
    /// <param name="dic">传入参数</param>
    /// <returns></returns>
    public DataTable CommonServicesremovebykey(string methodname, Dictionary<string, string> dic)
    {
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonServicesget(string methodname, Dictionary<string, string> dic)
    {
    ...
    public DataTable CommonServiceslist(string methodname, Dictionary<string, string> dic)
    {
    ...
    /// <param name="dic"></param>
    /// <returns></returns>
    public DataTable CommonService(string methodname,Dictionary<string, string> dic)
    {
        dic.AddServiceName(methodname);
        return DoCoreDataTable(dic);
    }
