...
namespace METU.Client
{
    ...
    {/// <summary>
     ...
     /// <returns></returns>
        ...
        {
            Microsoft.Win32.RegistryKey key = Microsoft.Win32.Registry.CurrentConfig;
        ...
        public static List<string> ReadKeyNames(string subkeyName)
        {
            ...
            var key = Registry.CurrentConfig.OpenSubKey(subkeyName, true);
            //先获取ValueName
