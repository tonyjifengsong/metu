...
namespace METU.SerialCores
{
...

    {
        ...
        public SerialCore(string comPortName)
        ...
        public SerialCore(string comPortName, int baudRate, Parity parity, int dataBits, StopBits stopBits)
