...
{
  public partial  class MetuPageBase :  PageModel
    {
        ...
        protected   ILogger<MetuPageBase> logger;
        ...
        public MetuPageBase(ILogger<MetuPageBase> _logger, CoreBLL context)
        {
            me = new metucore();
            ME = new METUCORE();
            _context = context;
        ...
        public MetuPageBase(CoreBLL context)
        {
            ME = new METUCORE();
            me = new metucore();
            _context = context;
